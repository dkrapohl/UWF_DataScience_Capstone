...
Where TP is the true positive rate and FN is the false negative rate. The recall for the selected random forest model is 71.6% which also represents the model to be ability of the model to discover true positives.
...
The F1 score for the random forest model is 73.1% indicating a well-balanced model that has a fairly high discernment capability between the up and down classes in the dataset.
